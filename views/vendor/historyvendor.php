                    ...
                    <table class="table"> 
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $x['file'] ?></td>
                                <td><?= $x['status'] ?></td>
                                <td><a href="<?php echo base_url()?>admin/update/<?= $x['id']?>"><button style="background-color:yellow">Update</button></a>
                                <a href="<?php echo base_url()?>admin/hapus/<?= $x['id']?>"><button style="background-color:red">Delete</button></a>
                                <a href="http://127.0.0.1/printpbw/uploads/<?php echo $x['file'] ?>"<button style="background-color:red">Download</button></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
