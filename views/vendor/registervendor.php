                ...
                <div style="padding:20px;" class="text-center">
                    ...
                    <div class="col-md-4 text-center">
                        ...
                        <input type="hidden" name="<?=$csrf['name'];?>" value="<?=$csrf['hash'];?>" /> 
                            ...
                            <div class="form-group"> 
                                <label class="control-label" for="exampleInputPassword1">Rekening</label>                                 
                                <input type="text" name="rekening" class="form-control" id="exampleInputPassword1" placeholder="Masukkan nomer rekening"> 
                            </div>                             
