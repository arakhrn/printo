        ...
        <header id="header_outer"> 
            ...
            <div class="container" style="padding:20px;">
                ...
                <div class="row" style="padding:50px">
                    ...
                    <div class="col-md-4 text-center">
                        <h3>Pesanan </h3> 
                        <p>Menu untuk melihat pesanan print</p>
                        <a href="<?php echo site_url('user/readPesanan')?>">
                            <img src="https://image.flaticon.com/icons/svg/172/172164.svg" class="img-responsive img-thumbnail" width="30%" />
                        </a>
                    </div>
                    <div class="col-md-4 text-center">
